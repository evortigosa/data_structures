...
public final class Grafo {
     ...
     * @return Retorna verdadeiro se o vértice foi inserido, falso em caso contrário
     */
    public boolean insereVertice(String ator) {

        if (this.vertices.existeElemento(ator)!= null) return false;
        else {
            this.vertices.insereNaLista(ator);
            return true;
        }
    }
    /**
